...
| **看最新开发日志** | `woworld-dev-plan/01-核心基础/devlogs/DEVLOG-2026-07-12-sprint069.md` (Sprint-069 Vf 食物源落地·Poisson disc Bridson 2007 + 群系→产物硬编码映射 + `HarvestableInfo` 补 `regen_state`·1092 tests) |
| **看最新交接文档** | `woworld-dev-plan/01-核心基础/handoff/handoff-20260712-sprint069.md` (2026-07-12 Sprint-069 执行·村庄切片4/10·下一步 V2 牵引移动·1092 tests·待推送) |
