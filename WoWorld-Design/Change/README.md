...
| CHG-064 | — | 2026-07-03 | 轨A 昼夜循环 + 5群系系统。CLAUDE.md 引用——CHG 文件待补。 | ⚠️ 文件缺失 |
| CHG-065 | [CHG-065-地形修改编排层-20260706.md](CHG-065-地形修改编排层-20260706.md) | 2026-07-06 | 地形修改编排层——`woworld_core::edit_terrain`·CoW 存储·ModificationBatch·DirtyChunkQueue·EditDensityLayer | 完成 |
| CHG-066 | [CHG-066-对话气泡术语消歧-20260708.md](CHG-066-对话气泡术语消歧-20260708.md) | 2026-07-08 | 对话气泡术语消歧 + Bark MVP——807 tests | 完成 |
| CHG-067 | [CHG-067-物理运动学地基-20260709.md](CHG-067-物理运动学地基-20260709.md) | 2026-07-09 | 物理运动学地基——质量→冲量→单体 COM 涌现·不引擎 | 完成 |
| **CHG-068** | [CHG-068-视距扩展与海洋升级-20260710.md](CHG-068-视距扩展与海洋升级-20260710.md) | 2026-07-10 | ★视距 15→40km·双层海陆噪声·LOD 8→10层·双Tier海洋·TOML波参数·ViewDistance类型·连续滑块调节 | 🟡 设计完成 |
...
> **最后更新**: 2026-07-10 — CHG-068 已登记。视距扩展与海洋升级（5篇新文档）。
