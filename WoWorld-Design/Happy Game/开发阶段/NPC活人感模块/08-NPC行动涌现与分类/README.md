...
| [[003-领域复合原子与模块注册]] | 003 | ~40 个领域复合原子的定义、物理原子编排序列、模块注册机制 · 含 v1.2 ActionCandidate.prediction / mental_model_modulation |
| [[004-AgentSnapshot与连续参数涌现]] | 004 | AgentSnapshot 完整字段定义、与生命周期/身体状态/认知的派生关系 · 含 v1.1 CognitiveTide 3字段 |
